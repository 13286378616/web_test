...
public class Base4 {
	private Logger logger = Logger.getLogger(Base4.class);
	...
	public void init(String browserType,String driverPath){
		...
		sendKeys(getElement("登录页", "请输入用户名"),"13286378616");
		sendKeys(getElement("登录页", "请输入密码"), "a222222");
		click(getElement("登录页", "登录"));
		String actualconpany = getElement(By.xpath("//div[@class='ivu-dropdown-rel']/a")).getText();
		AssertionUtil.assertTextEquals(actualconpany, "天津开发区津海通物流有限公司上海分公司");
	}
	@AfterSuite
